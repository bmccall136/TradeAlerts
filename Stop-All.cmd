...
set "PSFILE=C:\TradeAlerts\Stop-All-clean.ps1"

REM Write/refresh the PowerShell script so it always exists
"%PSEXE%" -NoProfile -ExecutionPolicy Bypass -Command "$code = @'
...
REM Run the script visibly and keep the window
"%PSEXE%" -NoExit -ExecutionPolicy Bypass -File "%PSFILE%"
