...
bak = P.with_suffix(f".html.bak_trv_api_render_v3FIX_{ts}")
shutil.copy2(P, bak)
print("Backup ->", bak)
...
if i == -1 or j == -1 or j < i:
    print("ERROR: V2 markers not found or out of order; file drift. Not patched.")
    raise SystemExit(1)
