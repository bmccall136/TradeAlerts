...
MARK_START = "MM_REGIME_EXIT_OVERLAY_UI_V3_START"
MARK_END   = "MM_REGIME_EXIT_OVERLAY_UI_V3_END"
...
ui_block = ui_block.replace("__MM_START__", MARK_START).replace("__MM_END__", MARK_END)
ui_block = ui_block.replace("__MM_ROWS__", build_rows())
...
for path in candidates:
    ...
    bak = path.with_suffix(path.suffix + f".bak_reo_ui_v3_{ts}")
