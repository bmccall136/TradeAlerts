...
def build_place_body_from_preview(prev: dict, qty_override: int|None=None) -> tuple[str, dict]:
...
def main():
    ...
    if args.debug:
        ...
        print("[DBG] place body:"); print(j(place_body))
