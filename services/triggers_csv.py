...
FIELDS = [
    "ts_et", "symbol", "price", "signals",              # core
    "adx", "macd", "macd_signal", "macd_hist", "rsi",   # momentum
    "sma20", "sma50", "sma200",                         # trend
    "bb_upper", "bb_lower", "atr",                      # bands/volatility
    "volume", "avg_volume", "gap_pct", "day_chg_pct",   # tape/changes
    "rank", "score", "scanner", "notes"                 # ranking/meta
]
...
def emit_trigger(
    *,
    ...
    sig_str = "; ".join(signals) if isinstance(signals, (list, tuple)) else str(signals or "")
