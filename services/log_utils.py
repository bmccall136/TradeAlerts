    ...
    log_trigger(
        {
            ...
            "RSI": metrics.rsi,
            "MACD": metrics.macd_cross,
            "BB_breakout": metrics.bb_breakout,
            "Vol_mult": metrics.vol_mult,
            "VWAP_diff_pct": metrics.vwap_diff_pct,
            "ATR_ge": metrics.atr_ok,
            "ATRpct_ge": metrics.atr_pct_ok,
            "Range_ge": metrics.range_ok,
            "Gap_ge": metrics.gap_ok,
