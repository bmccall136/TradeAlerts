...
bak = P.with_suffix(f".py.bak_candidate_fires_schema_adaptive_v3b_{ts}")
shutil.copy2(P, bak)
print(f"Backup -> {bak}")
...
blk = (
    ...
    f"{ind}        # HTTP 200 on purpose so Invoke-WebRequest doesn't throw\n"
...
print("Replaced V2S block -> schema-adaptive V3b (no nested f-string)")
